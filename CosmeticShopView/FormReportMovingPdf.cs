...
namespace CosmeticShopView
{
    public partial class FormReportMovingPdf : Form
    {
        ...
        private void ButtonMake_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var dataSource = logic.GetCosmetics(dateTimePickerFrom.Value.Date, dateTimePickerTo.Value.Date);
        ...
        private void FormReportSetCosmetics_Load(object sender, EventArgs e)
        {
